...
"""
Create a temporary conda env, install CoCo from a wheel, run conda-pack.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Conda-pack CoCo (temp env).",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    try:
        ...
        try:
            ...
            print(
                ...
                "installing coco[full]"
            )
            needs_llama_compile = True

        # Install coco with all dependencies

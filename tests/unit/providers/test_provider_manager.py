...
from coco.exceptions import ProviderError
from coco.providers.anthropic_provider import AnthropicProvider
from coco.providers.models import ModelSlotConfig
from coco.providers.openai_provider import OpenAIProvider
from coco.providers.provider import ModelInfo
from coco.providers.provider_manager import ProviderManager
from coco.local_models.llamacpp import LlamaCppServerSetupResult
...
async def test_resume_local_model_restores_server_and_runtime_state(
    ...
    manager = ProviderManager()
    model_id = "AgentScope/CoCo-flash-2B-Q4_K_M"
    ...
    provider = manager.get_provider("coco-local")

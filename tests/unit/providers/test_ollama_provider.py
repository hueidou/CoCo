...
from coco.providers.ollama_provider import OllamaProvider
...
def test_client_uses_single_v1_suffix(monkeypatch, base_url: str) -> None:
    ...
    monkeypatch.setattr(
        "coco.providers.ollama_provider.AsyncOpenAI",
        FakeAsyncOpenAI,
    )
...
def test_get_chat_model_instance_uses_single_v1_suffix(
    ...
    monkeypatch.setattr(
        "coco.providers.openai_chat_model_compat.OpenAIChatModelCompat",

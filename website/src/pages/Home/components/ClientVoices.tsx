...
const AVATARS = [
  {
    key: "a1",
    src: AVATAR_URLS.a1,
    alt: "CoCo user avatar 1",
  },
  {
    key: "a2",
    src: AVATAR_URLS.a2,
    alt: "CoCo user avatar 2",
  },
  {
    key: "a3",
    src: AVATAR_URLS.a3,
    alt: "CoCo user avatar 3",
  },
  {
    key: "a4",
    src: AVATAR_URLS.a4,
    alt: "CoCo user avatar 4",
  },
  {
    key: "a5",
    src: AVATAR_URLS.a5,
    alt: "CoCo user avatar 5",
  },
] as const;
...
export function CocoClientVoices() {
  ...
  return (
    <motion.section
      ...
      aria-labelledby="coco-client-voices-heading"
    >

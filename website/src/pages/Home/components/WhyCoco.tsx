...
export function CocoWhy() {
  ...
  const heroLine = t("whyCoco.heroLine");
  const secondPrefix = t("whyCoco.secondPrefix");
  const secondEmphasis = t("whyCoco.secondEmphasis");
  const secondSuffix = t("whyCoco.secondSuffix");
        ...
        >
          <div className="relative pt-7 md:pt-10">
            ...
            <h2 className="font-newsreader font-semibold relative z-10 text-3xl leading-[0.98] text-[#ffffff] sm:text-[42px] md:text-[52px]">
              <span>{t("whyCoco.headingPrefix")} </span>
              <span className="inline-block italic whitespace-nowrap">
                {t("whyCoco.headingEmphasis")}
              </span>
              <svg
                aria-hidden
                viewBox="0 0 360 120"

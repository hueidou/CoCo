# -*- coding: utf-8 -*-
"""CLI command: run CoCo app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run CoCo app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing CoCo app instance.
    """
    ...
    click.echo(f"Starting CoCo app on {url} (port {port})")

...
@click.group(
    ...
    lazy_subcommands={
        "app": ("coco.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "coco.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("coco.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("coco.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("coco.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("coco.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("coco.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("coco.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("coco.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "coco.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("coco.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "coco.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("coco.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("coco.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "coco.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("coco.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("coco.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("coco.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": ("coco.cli.plugin_commands", "plugin", ".plugin_commands"),
        "task": ("coco.cli.task_cmd", "task_cmd", ".task_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="CoCo")

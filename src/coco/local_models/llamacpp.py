...
from coco.constant import DEFAULT_LOCAL_PROVIDER_DIR
...
class LlamaCppBackend:
    """
    CoCo local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"coco-llamacpp-download-{staging_dir.name}",
            command=["coco-llamacpp-download", download_url],

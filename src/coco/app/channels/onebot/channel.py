...
OneBot v11 implementation.  CoCo listens on a configurable port;
...
class OneBotChannel(BaseChannel):
    ...
    CoCo acts as a WebSocket server; NapCat (or compatible) connects
    ...
    def _parse_message_segments(
        ...
        """Parse OneBot v11 message segments to CoCo content_parts.

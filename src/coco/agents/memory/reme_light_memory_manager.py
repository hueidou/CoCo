...
# mypy: ignore-errors
"""ReMeLight-backed memory manager for CoCo agents."""
...
from coco.agents.memory.base_memory_manager import BaseMemoryManager
from coco.agents.model_factory import create_model_and_formatter
from coco.agents.tools import read_file, write_file, edit_file
from coco.agents.utils import get_coco_token_counter
from coco.config import load_config
from coco.config.config import load_agent_config
from coco.config.context import (
    set_current_workspace_dir,
    set_current_recent_max_bytes,
)
from coco.constant import EnvVarLoader
...
class ReMeLightMemoryManager(BaseMemoryManager):
    """Memory manager that wraps ReMeLight for CoCo agents via composition.
        ...
        **_kwargs,
        ...
        if extra_instruction:
            result = await self._reme.compact_memory(
                ...
                as_token_counter=get_coco_token_counter(agent_config),
        ...
        if not result.get("is_valid", True):
            ...
            try:
                ...
                logger.error(
                    ...
                    "https://github.com/agentscope-ai/CoCo/issues",
                )

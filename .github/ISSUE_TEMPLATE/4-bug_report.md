...
[Provide the version of CoCo you are using, e.g. 0.x.x or git commit hash.]
[Using `coco --version` in your command line or checking the version in the console UI can help.]
...
- **CoCo version:** [e.g. 0.x.x or git commit]
